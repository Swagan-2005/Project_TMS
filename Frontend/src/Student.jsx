...
function Student(){
    ...
    const onsubmit=async(data)=>{
        ...
        let newstudent=await axios.post(`${import.meta.env.VITE_API_URL}/api/addstudent`,data)
   
        handleget();
        }
        else{
            let updatestudent=await axios.put(`${import.meta.env.VITE_API_URL}/api/updatestudent/`+id,data)
    ...
    const deletedata=async()=>{
        ...
        let del=await axios.delete(`${import.meta.env.VITE_API_URL}/api/deletestudent/`+id);
        handleget();
    ...
    const searchdata=async()=>{
        ...
        if(search.length!=0){
            ...
            let val=await axios.get(`${import.meta.env.VITE_API_URL}/api/searchstudent?name=${search}`)
