...
function Course(){
    ...
    const onsubmit=async(data)=>{
        ...
        let newcourse=await axios.post(`${import.meta.env.VITE_API_URL}/api/addcourse`,data)
   
        handleget();
        }
        else{
            let updatecourse=await axios.put(`${import.meta.env.VITE_API_URL}/api/updatecourse/`+id,data)
    ...
    const deletedata=async()=>{
        ...
        let del=await axios.delete(`${import.meta.env.VITE_API_URL}/api/deletecourse/`+id);
        handleget();
    ...
    const searchdata=async()=>{
        ...
        if(search.length!=0){
            ...
            let val=await axios.get(`${import.meta.env.VITE_API_URL}/api/coursesearch?name=${search}`)
